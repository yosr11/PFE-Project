...
export const defaultNavigation: FuseNavigationItem[] = [
    {
        ...
        children: [
            {
                id   : 'dashboards.listeBateau',
                title: 'ListeBateaux',
                type : 'basic',
                icon : 'mat_outline:directions_boat_filled',
                link : '/dashboards/listeBateaux'
            },
            /*{
                id   : 'dashboards.FormBateau',
                title: 'FormBateau',
                type : 'basic',
                icon : 'mat_outline:directions_boat_filled',
                link : '/dashboards/formBateau'
            },*/
           /* {
                //id   : 'dashboards.editBateau',
                //title: 'editBateau',
                //type : 'basic',
                //icon : 'mat_outline:directions_boat_filled',
               // link : '/dashboards/editBateau/:id_bateau'
            },*/
            ...
            /*{
                ...
                title: 'Navigation',
                type : 'basic',
                icon : 'mat_outline:navigation',
                link : '/dashboards/navigation'
            },*/
            {
                id   : 'dashboards.controle',
                title: 'Controle',
                type : 'basic',
                icon : 'mat_outline:security',
                link : '/dashboards/controle'
            },
            {
                id   : 'dashboards.commande',
                title: 'Commande',
                type : 'basic',
            ...
            {
                id   : 'dashboards.locations_history',
                title: 'locations_history',
                type : 'basic',
                icon : 'history',
                link : '/dashboards/historique'
            },
            {
                id   : 'dashboards.outils-navigation',
                title: 'Outils-navigation',
                type : 'collapsable',
                icon : 'feather:tool',
                children:[
                    {
                       id:'dashboards.outils-navigation.geofence' ,
                       title:'Geofence',
                       type:'basic',
                       link:'/dashboards/outils-navigation/geofence'
                    },
                    {
                        id:'dashboards.outils-navigation.waypoint' ,
                        title:'Waypoint',
                        type:'basic',
                        link:'/dashboards/outils-navigation/waypoint'
                     },
                ]
            },
            
            {
                id   : 'dashboards.notif_param',
                title: 'notif_param',
                type : 'basic',
                icon : 'settings',
                link : '/dashboards/paramètres'
            },
